...
var _this = this;
var URL_ADRESS = 'https://api.punkapi.com/v2/beers?brewed_before=11-2017&abv_gt=6';
var wrapper = document.getElementById('wrapper');
var cardForBeer = function (arr) {
...
var fetchDataFromServer = function () { return __awaiter(_this, void 0, void 0, function () {
    var json, resultData, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
                return [4 /*yield*/, fetch("" + URL_ADRESS)];
            case 1:
                json = _a.sent();
